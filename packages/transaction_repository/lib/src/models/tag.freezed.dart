...
mixin _$Tag {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, budgetId, name);

  @override
  String toString() {
    return 'Tag(id: $id, budgetId: $budgetId, name: $name)';
  }
}
...
abstract mixin class $TagCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String budgetId, String name});
}
...
class _$TagCopyWithImpl<$Res> implements $TagCopyWith<$Res> {
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? id = null, Object? budgetId = null, Object? name = null}) {
    return _then(
      _self.copyWith(
        id: null == id
            ? _self.id
...
extension TagPatterns on Tag {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String budgetId, String name)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Tag() when $default != null:
        return $default(_that.id, _that.budgetId, _that.name);
      case _:
        return orElse();
    }
  }
...
class _Tag implements Tag {
  const _Tag({required this.id, required this.budgetId, required this.name});
